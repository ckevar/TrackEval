...
class Kitti2DBoxFairMOTMulticlass(_BaseDataset):
    ...
    def __get_valid_classes__(self):
        return ['car', 'van', 'truck', 'pedestrian', 'person', 'cyclist', 'tram']
    ...
    def __init__(self, config=None):
        ...
        # Get classes to eval
        self.valid_classes = self.__get_valid_classes__()
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        """
        if 2 == len(self.valid_classes) and 'pedestrian' in self.valid_classes and 'car' in self.valid_classes:
            if cls == 'pedestrian':
            ...
            distractor_classes = [self.class_name_to_class_id['misc'], 
                                  self.class_name_to_class_id['dontcare']]
        ...
        for t in range(raw_data['num_timesteps']):
            ...
            #print("\n  raw_data", raw_data["gt_classes"][t])
            #print("\n  cls of in", cls_id)
            ...
            tracker_class_mask = np.atleast_1d(raw_data['tracker_classes'][t])
