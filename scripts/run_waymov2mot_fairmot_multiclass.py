...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval.datasets.WaymoV2MotFairMOTMulticlass.get_default_dataset_config()
    ...
    dataset_list = [trackeval.datasets.WaymoV2MotFairMOTMulticlass(dataset_config)]
    metrics_list = []
