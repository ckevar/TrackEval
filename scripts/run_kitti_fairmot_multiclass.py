...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval.datasets.Kitti2DBoxFairMOTMulticlass.get_default_dataset_config()
    ...
    dataset_list = [trackeval.datasets.Kitti2DBoxFairMOTMulticlass(dataset_config)]
    metrics_list = []
